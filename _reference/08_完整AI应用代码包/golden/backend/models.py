...
class FeatureInputAssessment(StrictModel):
    """Small product-facing readiness contract for an independent result."""

    feature: Literal["process", "quote"]
    result_status: Literal["ready", "assumptions_only", "insufficient_input"]
