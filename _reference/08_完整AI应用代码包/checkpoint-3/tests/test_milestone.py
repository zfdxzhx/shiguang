...
from backend.models import DocumentType, DraftFinding, ReviewDraftV2
...
class MilestoneTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.app = create_application(server, runtime_root=Path(cls.temp.name) / "runtime")
    ...
    def test_03_multimodal_rules_evidence_and_human_gate(self):
        ...
        self.assertEqual("drawing-review:drawing-review-v2.7-kimi-location-cost", kimi_request["json"]["prompt_cache_key"])
    ...
    def test_08a_k3_deepseek_hybrid_images_then_minimized_text(self):
        ...
        self.assertEqual("drawing-review:drawing-review-v2.7-kimi-location-cost", kimi_request["prompt_cache_key"])
